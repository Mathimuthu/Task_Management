            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#tikit-Components" href="#"><i
                            class="icofont-Task"></i> <span>Tasks</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                    <!-- Menu: Sub menu ul -->
                    <ul class="sub-menu collapse" id="tikit-Components">
                        <li><a class="ms-link" href="Tasks.html"> <span>Tasks View</span></a></li>
                        <li><a class="ms-link" href="Task-detail.html"> <span>Task Detail</span></a></li>
                    </ul>
                </li>
                <li class="collapsed">
